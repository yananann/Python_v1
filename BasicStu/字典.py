    ...
    match select:
        case "1":#添加购物车
            ...
            if goods_name in shopping_cart:
                ...
                shopping_cart[goods_name] = {"price": price, "count": count}
                print("商品添加成功！")
        ...
        case "2":#修改购物车
            ...
            if goods_name not in shopping_cart:
                ...
                new_count = int(input("请输入新数量："))
                shopping_cart[goods_name]["count"] = new_count
                print("修改完成！")
        ...
        case "4":#查询购物车
            if not shopping_cart:
                ...
                for name, info in shopping_cart.items():
                    ...
                    total += subtotal
                    print(f"{name} 单价:{info['price']} 数量:{info['count']} 小计:{subtotal}")
                print(f"总价格：{total}\n")
